...
public class Bestiary {
	...
	public ArrayList<Monster> Aberrations = new ArrayList<Monster>();
	
	Monster gibberingMouther = new Monster("Gibbering Mouther", "Bites", "5d6 Piercing", "Blinding Spittle (Recharge 5-6)", "see Monster Manual page for special attacks", 2, 67, 2, 9, 157);
	
	
	public ArrayList<Monster> Celestials = new ArrayList<Monster>();
	
	public ArrayList<Monster> Constructs = new ArrayList<Monster>();
	
	public ArrayList<Monster> Elementals = new ArrayList<Monster>();
	
	public ArrayList<Monster> Fey = new ArrayList<Monster>();
	
	public ArrayList<Monster> Feinds = new ArrayList<Monster>();
	
	public ArrayList<Monster> Giants = new ArrayList<Monster>();
	
	public ArrayList<Monster> Monstrosities = new ArrayList<Monster>();
	
	public ArrayList<Monster> Oozes = new ArrayList<Monster>();
	
	public ArrayList<Monster> Plants = new ArrayList<Monster>();
